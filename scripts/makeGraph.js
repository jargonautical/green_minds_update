...
function update() {
  ...
  const simulation = d3.forceSimulation(nodes)
      ...
      .range(["#f0e100","#d16666","#38d430","#94f1ee","#004a98","#A09BE7", "#D6FF79"]);
      // Titanium Yellow, Fuzzy Wuzzy, Green Minds Green, Electric Blue, Yale Blue, Maximum Blue Purple, Mindaro
